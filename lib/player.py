...
class Player(FirstPersonController):
    ...
    def input(self, key):
        if key == '0':
            self.gun.color = ursina.color.white10
        elif key == '1':
            self.gun.color = ursina.color.rgb(0, 0, 0.4)
        elif key == '2':
            self.gun.color = ursina.color.white
        elif key == '3':
            self.gun.color = ursina.color.blue
        elif key == '4':
            self.gun.color = ursina.color.green
        elif key == '5':
            self.gun.color = ursina.color.red
        elif key == '6':
            self.gun.color = ursina.color.yellow
        elif key == '7':
            self.gun.color = ursina.color.purple
        elif key == '8':
            self.gun.color = ursina.color.orange
        elif key == '9':
            self.gun.color = ursina.color.aqua
